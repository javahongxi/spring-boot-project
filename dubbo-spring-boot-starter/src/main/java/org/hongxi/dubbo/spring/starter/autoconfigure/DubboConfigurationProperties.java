 ...
 */
package org.hongxi.dubbo.spring.starter.autoconfigure;
 ...
 * @since 2.7.1
 */
@ConfigurationProperties(DubboUtils.DUBBO_PREFIX)
class DubboConfigurationProperties {
    ...
    static class Config {
         ...
         */
        private boolean multiple = DubboUtils.DEFAULT_MULTIPLE_CONFIG_PROPERTY_VALUE;

        /**
         * The property name of override Dubbo config
         */
        private boolean override = DubboUtils.DEFAULT_OVERRIDE_CONFIG_PROPERTY_VALUE;
