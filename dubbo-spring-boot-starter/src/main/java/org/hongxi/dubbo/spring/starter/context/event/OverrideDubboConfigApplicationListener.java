 ...
 */
package org.hongxi.dubbo.spring.starter.context.event;

import org.apache.dubbo.common.utils.ConfigUtils;
import org.apache.dubbo.config.AbstractConfig;
import org.hongxi.dubbo.spring.starter.util.DubboUtils;
...
public class OverrideDubboConfigApplicationListener implements ApplicationListener<ApplicationEnvironmentPreparedEvent> {
    ...
    public void onApplicationEvent(ApplicationEnvironmentPreparedEvent event) {
        ...
        boolean override = environment.getProperty(DubboUtils.OVERRIDE_CONFIG_FULL_PROPERTY_NAME, boolean.class,
                DubboUtils.DEFAULT_OVERRIDE_CONFIG_PROPERTY_VALUE);
        ...
        if (override) {
            ...
            if (logger.isInfoEnabled()) {
                logger.info("Disable override Dubbo Config caused by property {} = {}", DubboUtils.OVERRIDE_CONFIG_FULL_PROPERTY_NAME, override);
            }
        }
